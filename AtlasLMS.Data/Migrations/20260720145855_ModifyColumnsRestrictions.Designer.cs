...
namespace AtlasLMS.Data.Migrations
{
    ...
    [Migration("20260720145855_ModifyColumnsRestrictions")]
    partial class ModifyColumnsRestrictions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AtlasLMS.Domain.Entities.Book", b =>
                {
                    b.HasOne("AtlasLMS.Domain.Entities.Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AtlasLMS.Domain.Entities.Category", "Category")
                        .WithMany("Books")
